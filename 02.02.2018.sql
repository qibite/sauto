...
CREATE TABLE `incident` (
  ...
  `id_car` smallint(6) NOT NULL,
  `works` text NOT NULL,
  `parts` text,
  `master` varchar(50) NOT NULL,
  `time_to_start` datetime NOT NULL,
  `time_to_end_plane` datetime NOT NULL,
  `time_t_end_real` datetime DEFAULT NULL,
...
INSERT INTO `incident` VALUES (1,1,19,'[\"19\",\"16\",\"17\",\"11\",\"10\",\"14\",\"1\",\"21\",\"6\",\"8\"]',NULL,'1','2018-02-02 09:30:00','2018-03-03 14:10:00',NULL,700,1,8100),(2,1,19,'[\"16\",\"15\",\"18\",\"12\",\"14\",\"4\",\"10\",\"17\",\"3\",\"19\",\"9\"]',NULL,'1','2018-01-01 09:45:00','2018-01-05 10:35:00',NULL,1010,1,13050),(3,3,23,'[\"22\",\"15\",\"22\",\"16\",\"12\",\"18\"]',NULL,'2','2018-01-02 11:00:00','2018-01-05 10:40:00',NULL,460,1,7650);
...
CREATE TABLE `settings` (
  `start_day_h` char(10) DEFAULT '9',
  `start_day_m` char(10) DEFAULT '00',
  `start_obed_h` char(10) DEFAULT '13',
  `start_obed_m` char(10) DEFAULT '00',
  `end_obed_h` char(10) DEFAULT '14',
  `end_obed_m` char(10) DEFAULT '00',
  `end_day_h` char(10) DEFAULT '18',
  `end_day_m` char(10) DEFAULT '00',
...
INSERT INTO `settings` VALUES ('9','00','13','00','14','00','18','00','03.02.2018,04.02.2018,10.02.2018,11.02.2018,17.02.2018,18.02.2018,24.02.2018,25.02.2018');
...
-- Dump completed on 2018-02-02 10:15:05
